        ...
        <div className="flex justify-between">
          <div className="w-[20%] pt-10 pr-5 bg-[#f8f9fa] lg:block hidden">
            <ul className="cursor-pointer">
              {category?.map((item) => (
                <li className="flex justify-between capitalize items-center font-roboto text-[18px] font-normal py-5 hover:text-sky-400 duration-300 ease-in-out px-2">
                  {item}
                  <MdArrowForwardIos />
                </li>
              ))}
